...
class smt_model_single_scale(nn.Module):

    def __init__(self, alignsize=8, reddim=8, loadweight=True, model=None, downsample=4):
        super(smt_model_single_scale, self).__init__()
...
class smt_model_multi_scale_individual(nn.Module):

    def __init__(self, alignsize=8, reddim=32, loadweight=True, model=None, downsample=4):
        super(smt_model_multi_scale_individual, self).__init__()
...
class smt_model_multi_scale_shared(nn.Module):

    def __init__(self, alignsize=8, reddim=32, loadweight=True, model=None, downsample=4):
        super(smt_model_multi_scale_shared, self).__init__()
...
def build_smt_model(scale='single', alignsize=8, reddim=32, loadweight=True, model=None, downsample=4):
    if scale == 'single':
        return smt_model_single_scale(alignsize, reddim, loadweight, model, downsample)
    elif scale == 'multi':
        return smt_model_multi_scale_shared(alignsize, reddim, loadweight, model, downsample)
